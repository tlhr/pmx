...
class AbsoluteDG:
    """Class contains parameters for setting up absolute free energy calculations
    ...
    def __init__(self, **kwargs):
        ...
        self.proteins = {} # proteins[ligname] = {} for every ligname create a dictionary of proteins
                           # proteins[ligname][path]=path
                           # proteins[ligname][str]=pdb 
                           # proteins[ligname][itp]=[itps]
                           # proteins[ligname][posre]=[posres]
                           # proteins[ligname][mols]=[molnames]
